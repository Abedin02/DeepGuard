...
export default function ResultDetailPage({ params }) {
  ...
  if (!result) {
    return (
      <div style={{ minHeight: '100vh', background: 'transparent', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '1rem', fontFamily: "'Jost', sans-serif", transition: 'background-color 0.3s ease' }}>
        ...
        <RippleButton onClick={() => router.push('/')} style={{ marginTop: '0.5rem', padding: '0.65rem 1.5rem', backgroundColor: theme.primary, color: '#fff', border: 'none', borderRadius: '8px', cursor: 'pointer', fontFamily: "'Jost', sans-serif", fontWeight: '700', fontSize: '0.9rem', transition: 'background-color 0.3s ease' }}>
          Back to Scanner
        </RippleButton>
      </div>
    )
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'transparent', padding: '2rem 2rem 4rem', fontFamily: "'Jost', sans-serif", transition: 'background-color 0.3s ease' }}>
